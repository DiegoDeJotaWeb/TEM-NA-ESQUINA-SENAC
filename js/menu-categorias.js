...
function todasCategorias(){
    ...
    var categoria3 = document.getElementsByClassName('categoria3');
    var categoria4 = document.getElementsByClassName('categoria4');
    var categoria5 = document.getElementsByClassName('categoria5');
    var categoria6 = document.getElementsByClassName('categoria6');
    var categoria7 = document.getElementsByClassName('categoria7');
    ...
    for(let i = 0; i < categoria1.length; i ++){
        console.log(categoria1[i].style.display = 'block');
    }
    for(let i = 0; i < categoria2.length; i ++ ){
        console.log(categoria2[i].style.display = 'block');        
    }
    ...
    for(let i = 0; i < categoria5.length; i ++ ){
        console.log(categoria5[i].style.display = 'block');
        
    }
    for(let i = 0; i < categoria6.length; i ++ ){
        console.log(categoria6[i].style.display = 'block');
        
    }
    for(let i = 0; i < categoria7.length; i ++ ){
        console.log(categoria7[i].style.display = 'block');
...
function categoria1(){
    ...
    for(let i = 0; i < categoria2.length; i ++ ){
        console.log(categoria2[i].style.display = 'none');        
    }
    for(let i = 0; i < categoria3.length; i ++){
        console.log(categoria3[i].style.display = 'none');
    }
    for(let i = 0; i < categoria4.length; i ++ ){
    ...
    for(let i = 0; i < categoria5.length; i ++ ){
        console.log(categoria5[i].style.display = 'none');
        
    }
    for(let i = 0; i < categoria6.length; i ++ ){
        console.log(categoria6[i].style.display = 'none');
        
    }
    for(let i = 0; i < categoria7.length; i ++ ){
        console.log(categoria7[i].style.display = 'none');
...
function categoria2(){
    ...
    for(let i = 0; i < categoria1.length; i ++){
        console.log(categoria1[i].style.display = 'none');
    }
    for(let i = 0; i < categoria2.length; i ++ ){
        console.log(categoria2[i].style.display = 'block');        
    }
